...
# Add conan-community & conan-public as remotes. Needed until more packages are available in the official repository.
...
conan remote add conan-community https://api.bintray.com/conan/conan-community/conan >/dev/null 2>&1 || true
